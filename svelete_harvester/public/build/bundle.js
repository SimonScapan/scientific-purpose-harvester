    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file, 9, 2, 296);
    			add_location(br1, file, 9, 6, 300);
    			add_location(br2, file, 13, 3, 615);
    			add_location(br3, file, 13, 7, 619);
    			set_style(p, "font-family", "Arial");
    			set_style(p, "color", "white");
    			add_location(p, file, 10, 2, 308);
    			add_location(br4, file, 16, 2, 733);
    			add_location(br5, file, 16, 6, 737);
    			set_style(div0, "background-color", "grey");
    			set_style(div0, "border-radius", "5px");
    			add_location(div0, file, 8, 1, 235);
    			add_location(br6, file, 18, 1, 753);
    			add_location(br7, file, 18, 5, 757);
    			...
    			add_location(input, file, 19, 1, 764);
    			add_location(br8, file, 20, 1, 921);
    			add_location(br9, file, 20, 5, 925);
